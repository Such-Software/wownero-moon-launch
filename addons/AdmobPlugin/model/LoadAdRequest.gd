...
func set_ad_size(a_value: LoadAdRequest.RequestedAdSize) -> LoadAdRequest:
...
func set_ad_position(a_value: LoadAdRequest.AdPosition) -> LoadAdRequest:
...
func set_collapsible_position(a_value: LoadAdRequest.CollapsiblePosition) -> LoadAdRequest:
