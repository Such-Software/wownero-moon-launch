...
## Segments to capture (-> out/ai_pilot_short/)
...
MK_CAPTION="i taught an AI to land on the moon" \
  lib/capture.sh res://marketing/stage/Stage3D.tscn out/ai_pilot_short/seg_01.avi 180
MK_GLB=res://marketing/assets/characters/cosmonaut_doge.glb MK_ANIM=idle MK_CAPTION="can you do better?" \
  lib/capture.sh res://marketing/stage/Stage3D.tscn out/ai_pilot_short/seg_05.avi 240

# beat 2 early-flail gameplay: temporarily set bad params so it fails on purpose
AP_TURN_GAIN=1 AP_ESCAPE_RADIUS=120 \
  lib/capture.sh res://game/levels/1/Level1.tscn out/ai_pilot_short/seg_02.avi 360 --autopilot

# beat 3 the win (clean defaults)
lib/capture.sh res://game/levels/1/Level1.tscn out/ai_pilot_short/seg_03.avi 900 --autopilot

# beat 4 death by Martian (level 2+)
lib/capture.sh res://game/levels/2/Level2.tscn out/ai_pilot_short/seg_04.avi 700 --autopilot
```

## Assemble

```sh
lib/assemble.sh --out out/ai_pilot_short/final \
  --music assets/music/bed.mp3 \
  out/ai_pilot_short/seg_01.avi out/ai_pilot_short/seg_02.avi \
  out/ai_pilot_short/seg_03.avi out/ai_pilot_short/seg_04.avi \
  out/ai_pilot_short/seg_05.avi
